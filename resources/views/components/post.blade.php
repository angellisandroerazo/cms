<div class="flex justify-center p-5">
    <div class="relative w-full max-w-sm overflow-hidden rounded-lg shadow-lg group">
        ...
        <div class="relative">
            ...
            <span class="absolute text-xs font-bold rounded badge badge-primary top-2 left-2">
                {{$category}}
            </span>
        </div>
        ...
        <div class="p-5">
            ...
            <h2 class="text-lg font-bold transition duration-300 group-hover:text-primary group-hover:underline">
                {{$title}}
            </h2>
